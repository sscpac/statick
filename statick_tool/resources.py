"""
Manages plugin and file lookup chaining with user directories and the
default statick resource directory.
"""
...
class Resources(object):
    ...
    def get_file(self, filename):
        """
        Get full path to file given default and user-defined resource paths.
        """
        for path in self.paths:
