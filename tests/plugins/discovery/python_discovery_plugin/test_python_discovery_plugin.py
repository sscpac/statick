...
from statick_tool.plugins.discovery.python_discovery_plugin \
    import PythonDiscoveryPlugin
...
def test_python_discovery_plugin_scan_invalid_nocmake():
    cdp = PythonDiscoveryPlugin()
