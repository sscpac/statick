...
@mock.patch(
    "statick_tool.plugins.discovery.shell_discovery_plugin.subprocess.check_output"
)
def test_shell_discovery_plugin_scan_calledprocesserror(mock_subprocess_check_output):
    """
